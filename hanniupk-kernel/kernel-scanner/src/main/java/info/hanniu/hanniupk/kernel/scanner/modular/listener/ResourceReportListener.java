 ...
 */
package info.hanniu.hanniupk.kernel.scanner.modular.listener;

import info.hanniu.hanniupk.kernel.model.api.ResourceService;
import info.hanniu.hanniupk.kernel.model.resource.ResourceDefinition;
...
public class ResourceReportListener implements ApplicationListener<ApplicationReadyEvent>, ApplicationContextAware {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        System.out.println("发送本系统的所有资源到hanniupk-auth服务开始！");
        ...
        System.out.println("发送本系统的所有资源到hanniupk-auth服务完毕！");
    }
