 ...
 */
package info.hanniu.hanniupk.kernel.scanner.config;

import info.hanniu.hanniupk.kernel.scanner.config.properties.ScannerProperties;
import info.hanniu.hanniupk.kernel.scanner.modular.ApiResourceScaner;
import info.hanniu.hanniupk.kernel.scanner.modular.factory.ApiResourceFactory;
import info.hanniu.hanniupk.kernel.scanner.modular.factory.DefaultApiResourceFactory;
import info.hanniu.hanniupk.kernel.scanner.modular.listener.ResourceReportListener;
import info.hanniu.hanniupk.kernel.scanner.modular.service.ResourceCollectService;
...
import static info.hanniu.hanniupk.kernel.model.constants.ConfigPrefixConstants.SCANNER_PREFIX;
...
public class ScannerAutoConfiguration {
    ...
    /**
     * 资源扫描之后的资源汇报操作（向hanniupk-auth服务）
     */
    @Bean
