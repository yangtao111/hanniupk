 ...
 */
package info.hanniu.hanniupk.core.feign;
...
/**
 * hanniupk自己的feign错误解码器（为了feign接收到错误的返回，转化成hanniupk可识别的ServiceException）
 *
 * @author stylefeng
 * @Date 2018/4/20 23:14
 */
@Slf4j
public class HanniupkFeignErrorDecoder implements ErrorDecoder {
