 ...
 */
package info.hanniu.hanniupk.kernel.logger.chain.context;
...
import info.hanniu.hanniupk.kernel.model.constants.HanniupkConstants;
...
public class SpanIdContext {
    ...
    public static String getSpanIdByHttpHeader() {
        ...
        if (request == null) {
            ...
            String requestNo = request.getHeader(HanniupkConstants.SPAN_ID_HEADER_NAME);
