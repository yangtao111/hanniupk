 ...
 */
package info.hanniu.hanniupk.kernel.validator.aop;

import info.hanniu.hanniupk.kernel.model.constants.AopSortConstants;
...
public class ParamValidateAop {
    ...
    @Pointcut(value = "@annotation(info.hanniu.hanniupk.kernel.validator.stereotype.ParamValidator)")
