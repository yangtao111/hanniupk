 ...
 */
@RestController
@RequestMapping("/resourceServiceForGateWay")
public class ResourceServiceForGateWayProvider {

    @RequestMapping("/reportResources")
    ...
    @RequestMapping("/getUserResourceUrls")
